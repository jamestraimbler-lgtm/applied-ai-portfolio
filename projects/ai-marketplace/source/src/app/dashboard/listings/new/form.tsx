...
/**
 * New listing form — lets an existing seller create an additional listing.
 * Reuses the agent/connection/pricing steps from onboarding (without the
 * profile step). Calls listing.create, which creates the listing as DRAFT.
 */
      ...
      <div className={styles.card}>
        ...
        {step === 4 && (
          <>
            ...
            <h2>Review &amp; create</h2>
            <p className={styles.lead}>Check everything over. Your listing will be saved as a draft — submit it for review from your dashboard.</p>
        ...
        <div className={styles.actions}>
          {step > 1 ? (
            <button className="btn btn-ghost" onClick={back} disabled={create.isPending}>Back</button>
          ) : (
